...
run_test([
  ...
  // floats have no gcd: only a lone coefficient is divided out
  '0.5*x*y<y',
  '0.5*x*y<y',

  // test() keeps its arguments while they are undecided
  'test(x+y>y,1,0)',
  'test(x+y>y,1,0)',
...
const LINE: [string, string, ...[string, number][]][] = [
  ...
  ['and(x>1/2,x>2/3)', 'x>2/3', ['x,1', 1], ['x,1/4', 0], ['x,7/6', 1]],
  ...
  ['and(x>1,x<0.5)', '0', ['x,1/4', 0], ['x,3/4', 0], ['x,0', 0]],
  ['or(x<=0.25,x>1/4)', '1', ['x,1/8', 1], ['x,0', 1], ['x,-1/2', 1]],
  ['and(x>-2.5,x<=-1/4,x>=-5/2)', 'and(x>-2.5,x<=-0.25)', ['x,-11/8', 1], ['x,-1/8', 0], ['x,-2', 1]],
