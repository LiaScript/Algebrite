...
run_test([
  ...
  'roots(thePoly)',
  '[-(-1)^(1/9)+(-1)^(8/9),1/2*cos(1/9*pi)-1/2*cos(8/9*pi)+1/2*i*sin(1/9*pi)-1/2*i*sin(8/9*pi)+3^(1/2)*cos(11/18*pi),1/2*(cos(1/9*pi)-cos(8/9*pi)+i*sin(1/9*pi)-i*sin(8/9*pi)-2*3^(1/2)*cos(11/18*pi))]',
...
run_test([
  ...
  'roots(thePoly)',
  '[-(-1)^(2/9)+(-1)^(7/9),1/2*cos(2/9*pi)-1/2*cos(7/9*pi)+1/2*i*sin(2/9*pi)-1/2*i*sin(7/9*pi)+3^(1/2)*cos(13/18*pi),1/2*(cos(2/9*pi)-cos(7/9*pi)+i*sin(2/9*pi)-i*sin(7/9*pi)-2*3^(1/2)*cos(13/18*pi))]',
  // also: "[(3+1/3*(-27/2+27/2*i*3^(1/2))^(2/3)-3*i*3^(1/2)+1/3*i*3^(1/2)*(-27/2+27/2*i*3^(1/2))^(2/3))/(2*(-27/2+27/2*i*3^(1/2))^(1/3)),(3+1/3*(-27/2+27/2*i*3^(1/2))^(2/3)+3*i*3^(1/2)-1/3*i*3^(1/2)*(-27/2+27/2*i*3^(1/2))^(2/3))/(2*(-27/2+27/2*i*3^(1/2))^(1/3)),(-3-1/3*(-27/2+27/2*i*3^(1/2))^(2/3))/((-27/2+27/2*i*3^(1/2))^(1/3)))",
...
run_test([
  ...
  'roots(thePoly)',
  '[1/6*(-4+73^(1/3)-i*3^(1/2)*73^(1/3)),1/6*(-4+73^(1/3)+i*3^(1/2)*73^(1/3)),1/3*(-2-73^(1/3))]',
...
run_test([
  ...
  '[2/3-1/3*(-1)^(1/3)*37^(1/3),1/6*(4-37^(1/3)+i*3^(1/2)*37^(1/3)),1/3*(2+37^(1/3))]',
