...
export const EIGENVALUES = 'eigenvalues';
export const EIGENVECTORS = 'eigenvectors';
...
export const MATRIXRANK = 'matrixrank';
export const MEAN = 'mean';
export const MEDIAN = 'median';
export const VARIANCE = 'variance';
export const SVARIANCE = 'svariance';
export const SD = 'sd';
